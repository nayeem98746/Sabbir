...
const Banner = () => {
    ...
    // scroll the page to spcifiq id element
    function ScrollPage_Target_ID(id:string){
                ...
                <div className="flex flex-col items-center text-center lg:items-start lg:text-left text-white">
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mt-10">
                        <button
                            ...
                            onClick={()=>ScrollPage_Target_ID("contact_id")}
                        >
                            Contact Now
                        </button>
                        <button
                        ...
                        <NavLink href={CV_DRIVE_URL.DOWNLOAD.replace("view","download")} legacyBehavior>
                            <button className="h-12 px-6 rounded-full border border-white/20 bg-transparent text-white font-bold text-sm cursor-pointer hover:border-teal-400 hover:text-teal-400 transition-all duration-300">
                                Download CV
                            </button>
                        </NavLink>
                    </div>
